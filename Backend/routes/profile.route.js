...
import {createProfile,upProfile,getMyProfile,updateProfile,updateEmail,updatePassword,
  updateRole,updateStatus,getAllUser,getUserById,getUserByEmail,amountUser,editServiceArea,
getProfileById} from "../controllers/profile.controller.js";
...
route.get("/readmyprofile/:id",verifytoken,getMyProfile);
route.get("/readprofile/:id",getProfileById);
